...
const selectTriggerVariants = cva(
  `
		...
		*:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 *:data-[slot=select-value]:whitespace-nowrap
    ...
    <SelectPortal>
      ...
      >
        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            `
							relative z-[300] max-h-(--available-height) min-w-(--anchor-width) overflow-x-hidden overflow-y-auto
